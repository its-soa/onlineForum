...
<html>
<head>
<title> La Toya| Fashion Lovers </title>
<style>
    
    body{
         background-image: url(fashion/t.jpeg);
        color: firebrick;
        text-align: center;
    }
...
<body>
     ...
     <br> <h1> La Toya Fashion Page </h1> <br>
   ...
   <h2> Welcome To Our Fashion Hub</h2>
    
    <h3> An Avenue Where Fashion Lovers Get To Interact </h3> <br>
    
    <div > 
    <?php
    
    $select = mysqli_query($db, "SELECT * FROM posts WHERE category_id = 2
   ...
   <div class="footer"> 
    ...
    $select_cat = mysqli_query($db, "SELECT * FROM categories WHERE category_id = 2
