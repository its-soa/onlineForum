...
<html>
<head>
<title> La Toya| Movie Lovers </title>
<style>
    
      body{
         background-image: url(fashion/8.jpeg);
...
<body>
     ...
     <br> <h1> La Toya Movies Page </h1> <br>
   ...
   <h2> Welcome To Our Movies Hub</h2>
    
    <h3> An Avenue Where Movie Lovers Get To Interact </h3> <br>

    
    <?php
    
    $select = mysqli_query($db, "SELECT * FROM posts WHERE category_id = 1
   ...
   <!--  <th> <h3> Posts Id </h3></th>
    ...
    $select_cat = mysqli_query($db, "SELECT * FROM categories WHERE category_id = 1
